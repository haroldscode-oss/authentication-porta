...
import { ArrowLeft, EnvelopeSimple, DeviceMobile } from "@phosphor-icons/react"
import ssLogo from "@/assets/images/Seller_Services_Logo.png"

interface ResetMethodCardProps {
  email: string
  onBack: () => void
  onMethodSelect: (method: 'email' | 'sms') => void
}

export function ResetMethodCard({ email, onBack, onMethodSelect }: ResetMethodCardProps) {
  return (
      ...
      <div className="rounded-2xl p-8 transition-all duration-300" style={{
        ...
        <div className="space-y-3">
          <Button
            ...
            className="w-full h-12 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 transition-all duration-200 shadow-lg flex items-center justify-center gap-3"
          >
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-xl">
          <p className="text-sm text-muted-foreground text-center">
            We'll send a verification code to the {' '}
